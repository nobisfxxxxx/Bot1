...
NORMAL_REPLY = "Oye message karega toh tere bhen/maa ko utha ke bhaag jaunga"
BOSS_USERNAME = "phewphewwiww"
BOSS_REPLIES = [
    "Hey @phewphewwiww, I’m watching you 👀. Fix the script now!",
        ...
        try:
            ...
            for thread in threads:
                ...
                if sender_username == BOSS_USERNAME:
                    ...
                    reply = f"@{sender_username} {NORMAL_REPLY}"
